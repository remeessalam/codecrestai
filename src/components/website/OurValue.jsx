      ...
      <div className="wrapper grid md:grid-cols-2 items-center gap-7">
        <div className="flex flex-col items-start gap-5">
          ...
          <p data-aos="fade-up" className="desc">
            At CodeCrestAI, we specialize in transforming visions into digital
            realities. Our expertise in Web Development, UI/UX Design, Data
            Science Services, and App Development empowers businesses to thrive
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <div className="w-full bg-white h-2 rounded-full overflow-hidden">
              <div className="bg-gray-400 h-full w-[95%]"></div>
            </div>
          </div>
          <div className="flex flex-col gap-2">
            <div className="flex justify-between gap-4">
            ...
            <div className="w-full bg-white h-2 rounded-full overflow-hidden">
              <div className="bg-gray-400 h-full w-[98%]"></div>
            </div>
          </div>
          <div className="flex flex-col gap-2">
            <div className="flex justify-between gap-4">
            ...
            <div className="w-full bg-white h-2 rounded-full overflow-hidden">
              <div className="bg-gray-400 h-full w-[92%]"></div>
            </div>
          </div>
          <div className="flex flex-col gap-2">
            <div className="flex justify-between gap-4">
              <p className="">Data Science Services</p>
              <p className="">90%</p>
            </div>
            <div className="w-full bg-white h-2 rounded-full overflow-hidden">
              <div className="bg-gray-400 h-full w-[90%]"></div>
            </div>
          </div>
        </div>
      </div>
