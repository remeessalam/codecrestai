  ...
  return (
    <div className="bg-gradient-to-b text-background from-primary to-primary py-[2rem]">
      ...
      >
        ...
        >
          <h1 className="heading-1 text-white">{yrs}+</h1>
        ...
        <div
          ...
          className="w-full flex flex-col items-center justify-center"
        >
          <h1 className="heading-1 text-white">{experts}+</h1>
        ...
        <div
          ...
          className="w-full flex flex-col items-center justify-center"
        >
          <h1 className="heading-1 text-white">{clients}+</h1>
        ...
        <div
          ...
          className="w-full flex flex-col items-center justify-center"
        >
          <h1 className="heading-1 text-white">{completedProjects}+</h1>
